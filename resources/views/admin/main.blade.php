...
<html lang="en">
    ...
    <body id="body" class="dark-sidebar">
                ...
                <div class="menu-body navbar-vertical">
                    <div class="collapse navbar-collapse tab-content" id="sidebarCollapse">
                        ...
                        <ul class="navbar-nav tab-pane active" id="Main" role="tabpanel">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('siteuser.index') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('logout') }}" class="nav-link delete-btn" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <i class="ti ti-transfer-out menu-icon"></i>
                                    <span>Выход</span>
                                </a>
        ...
        <script src="/assets/plugins/wysiwyg/jquery.tinymce.min.js"></script>
